...
const COTabla = ({dato, setDato, datos, setListUpdated}) => {
...
const requestInit = {
    ...
    method: 'DELETE'
        ...
        fetch('http://localhost:9000/api8' + id, requestInit)
    ...
    return ( 
        ...
        <table className="table">
            ...
            <tbody>
                ...
                {datos.map(dato => (
                    <tr key={dato.id}>
                        <td ><input value={dato} className="form-check-input" type="radio" name="seleccion" id="flexRadioDefault1"/></td>
                        <td>{dato.id}</td>
                        <td>{dato.Tema}</td>
